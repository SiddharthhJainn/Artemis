...
// Tue Apr 12 11:01:11 2022 by ROOT version 6.24/02
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           jjnum;
   Int_t           Asj;
   Double_t        Asj_px[12];   //[Asj]
   Double_t        Asj_py[12];   //[Asj]
   Double_t        Asj_pz[12];   //[Asj]
   Double_t        Asj_e[12];   //[Asj]
   Double_t        Asj_eta[12];   //[Asj]
   Double_t        Asj_phi[12];   //[Asj]
   Double_t        Asj_theta[12];   //[Asj]
   Double_t        Asj_pt[12];   //[Asj]
...
void MyClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("jjnum", &jjnum, &b_jjnum);
